...
<template>
    <div class="recent-posts pt-5">
        <h4 class="mb-3">最近 貼文</h4>
        <div class="post-item">
            <a href="single-post.html" class="post-title">標題...</a>
            <div class="post-meta">
                <span><i class="far fa-user"></i> Posted by hahaha</span
                ><span><i class="far fa-calendar"></i> 30 07 2023</span
                ><span><i class="far fa-comment-alt"></i> 0 評論</span>
            </div>
        ...
        <div class="popular pt-5">
            <h4 class="mb-3">閱讀最熱門貼文</h4>
            <div class="card bg-dark text-white">
                <img
                    :src="img_architecture_1857175_1920"
                    class="card-img"
                    alt="..."
                />
                <div class="card-img-overlay p-3">
                    <div class="text-overlay">
                        <h5 class="card-title text-uppercase">標題</h5>
                        <div class="line"></div>
                        <div class="card-text article-meta">
                            <span
                                ><i class="far fa-user"></i> Posted by hahaha </span
                            ><span
                                ><i class="far fa-calendar"></i> 30 07
                                2023</span
                            ><span
